...
## Current state
- Features: Toggle read/write/execute for user/group/other plus setuid/setgid/sticky; converts to octal and symbolic; copy chmod command; reset; octal input backfills checkboxes; explain mode hover breakdown for octal digits; security hint warnings for risky selections; path-aware helper for common recommendations; aria-live status; labeled sections; on-page notes/privacy; metadata + FAQ JSON-LD.
