        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <label className="flex items-center gap-2 text-xs font-medium text-slate-700">
            <input
              ...
              checked={trimInput}
              onChange={(e) => {
                // Update the option itself (previously missing — the checkbox
                // could never be unchecked) and re-parse with the new setting.
                setTrimInput(e.target.checked);
                handleChange(e.target.checked ? input.trim() : input);
              }}
