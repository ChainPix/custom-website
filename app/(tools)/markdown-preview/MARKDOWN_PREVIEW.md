...
## Current state
- Features: Markdown textarea with live HTML preview; sample buttons (basic, code, tables); reset; sanitize toggle (default ON); copy HTML and copy markdown; download HTML.
