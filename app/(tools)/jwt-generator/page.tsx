    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JWT Generator and Verifier tool",
      },
    ],
  },
  twitter: {
...
export default function JwtGeneratorPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Can I set custom claims and expiry times?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. You can edit the payload JSON directly and use time helpers to set exp, iat, and nbf claims.",
        },
      },
    ],
  };
